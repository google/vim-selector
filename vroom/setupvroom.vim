...
" This file is used from vroom scripts to bootstrap the selector plugin and
" configure it to work properly under vroom.

" selector does not support compatible mode.
set nocompatible
...
" |load-plugins| time.
call maktaba#plugin#Get('selector').Load()
